        ...
        <div class="card">
          ...
          <div class="card-footer">
            <div class="card-footer-item">
              <a v-if="!is_subscribed(show.show)" @click="subscribe(show.show)"><fa-icon icon="rss" /> Subscribe</a>
              <a v-if="is_subscribed(show.show)" @click="subscribe(show.show)" class="has-text-success"><fa-icon icon="rss" /> Subscribed!</a>
            </div>
          </div>
        </div>
      </div>
